...
/** A lookup function with delayed join feature for {@link JdbcDynamicTableSource}. */
public class JdbcRowDataDelayedLookupFunction extends TableFunction<RowData> {
    private static final Logger LOG = LoggerFactory.getLogger(JdbcRowDataDelayedLookupFunction.class);
    ...
    public JdbcRowDataDelayedLookupFunction(
            JdbcOptions options,
        ...
        this.delayMs = lookupOptions.getDelayMs();
        this.query =
                options.getDialect()
